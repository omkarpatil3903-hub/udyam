...
export default function PrintCertificates({ onLogout }) {
    ...
    useEffect(() => {
        const q = query(collection(db, "printcertificates"), orderBy("timestamp", "desc"));
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <div className="flex items-center gap-3">
                        <h3 className="font-bold text-gray-900">Print Certificates</h3>
                    ...
                    <div className="min-w-[800px]">
                        ...
                        {filteredData.length === 0 && (
                            <div className="flex flex-col items-center justify-center py-16">
                                ...
                                <h3 className="text-lg font-bold text-gray-400">No print requests found</h3>

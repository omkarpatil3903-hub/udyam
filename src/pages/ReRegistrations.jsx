...
import { CreditCard, Clock, User, FileText, CheckCircle, Eye, AlertCircle, IndianRupee, Hash } from 'lucide-react';
import ReRegistrationViewModal from '../components/ReRegistrationViewModal';
import AdminLayout from '../components/AdminLayout';

export default function ReRegistrations({ onLogout }) {
    ...
    useEffect(() => {
        const q = query(collection(db, "reregistrations"), orderBy("timestamp", "desc"));
    ...
    const handlePaymentStatusUpdate = async (id, newStatus) => {
        try {
            if (!id) return;
            const registrationRef = doc(db, "reregistrations", id);
    ...
    const filteredData = registrations.filter(item => {
        const matchesSearch =
            ...
            item.uamNumber?.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <div className="flex items-center gap-3">
                        <h3 className="font-bold text-gray-900">Re-registrations</h3>
                ...
                <div className="overflow-x-auto">
                    <div className="min-w-[800px]">
                        ...
                        <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-gray-50/50 text-xs font-bold text-gray-500 uppercase tracking-wider">
                            ...
                            <div className="col-span-2">UAM Number</div>
                        ...
                        {filteredData.length === 0 && (
                            <div className="flex flex-col items-center justify-center py-16">
                                ...
                                <h3 className="text-lg font-bold text-gray-400">No re-registrations found</h3>

...
export default function RegistrationViewModal({
  isOpen,
  onClose,
  data,
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 bg-linear-to-r from-blue-50 to-blue-50/50 px-4 py-2 rounded-xl border border-blue-200 shadow-sm">
                ...
                <select
                  ...
                  className={`font-semibold text-sm px-3 py-1.5 rounded-lg border-2 cursor-pointer transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 ${
                    isPaid

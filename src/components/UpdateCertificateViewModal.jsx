...
import { X, Printer, FileText, User, MapPin, CreditCard, Clock, CheckCircle, Hash, MessageSquare } from 'lucide-react';

export default function UpdateCertificateViewModal({ isOpen, onClose, data, onPaymentStatusUpdate, onWorkStatusUpdate }) {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[95vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-100">
                ...
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-800">Update Certificate Details</h2>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-white">
                    ...
                    {/* Status Banner */}
                    <div className="mb-6 flex items-center justify-between bg-amber-50 p-4 rounded-lg border border-amber-100">
                        <div className="flex gap-8">
                            <div>
                                <span className="text-xs font-bold text-amber-400 uppercase tracking-wider block mb-1">Payment Status</span>
                            ...
                            {isPaid && (
                                <div>
                                    <span className="text-xs font-bold text-amber-400 uppercase tracking-wider block mb-1">Work Status</span>
                            ...
                            <div>
                                <span className="text-xs font-bold text-amber-400 uppercase tracking-wider block mb-1">Applied On</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-sm font-bold text-gray-900 border-b pb-2 flex items-center gap-2">
                                <User size={16} className="text-amber-500" /> Applicant Information
                            </h3>
                            <div className="grid grid-cols-1 gap-y-3 text-sm">
                                ...
                                <DetailRow label="OTP Option" value={data.otpOption === 'mobile' ? 'Mobile Number' : 'Email ID'} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-sm font-bold text-gray-900 border-b pb-2 flex items-center gap-2">
                                <Hash size={16} className="text-orange-500" /> Certificate Details
                            </h3>
                            <div className="grid grid-cols-1 gap-y-3 text-sm">
                        ...
                        <div className="space-y-4 md:col-span-2">
                            <h3 className="text-sm font-bold text-gray-900 border-b pb-2 flex items-center gap-2">
                                <MessageSquare size={16} className="text-blue-500" /> Details to Update
                            </h3>
                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <p className="text-sm text-gray-700 whitespace-pre-wrap">{data.updateDetails || 'No details provided'}</p>
                            </div>
                        </div>

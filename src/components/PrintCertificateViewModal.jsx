...
export default function PrintCertificateViewModal({ isOpen, onClose, data, onPaymentStatusUpdate, onWorkStatusUpdate }) {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[95vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-100">
                ...
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-800">Print Certificate Details</h2>
